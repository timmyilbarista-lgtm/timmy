    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-900 via-stone-800 to-stone-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <div className="mb-6 text-center">
            ...
            <div className="flex items-center justify-center gap-1.5 mt-0" style={{ marginLeft: '-14px' }}>
              <span className="text-[8px] text-amber-300">EST.</span>
              <span className="w-1 h-1 rounded-full bg-amber-400"></span>
              <svg width="20" height="28" viewBox="0 0 24 32" fill="none">
                <ellipse cx="12" cy="16" rx="10" ry="14" fill="#C4956A" opacity="0.95"/>
                <path d="M12 5C12 5 13 15 12 27" stroke="#6B4423" strokeWidth="1" fill="none"/>
              </svg>
              <span className="w-1 h-1 rounded-full bg-amber-400"></span>
              <span className="text-[8px] text-amber-300">2.0</span>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <div className="border-t border-stone-700 pt-8 mt-8">
          <p className="text-stone-400 text-sm mb-1">Powered by Timmy|CoffeeMaster</p>
